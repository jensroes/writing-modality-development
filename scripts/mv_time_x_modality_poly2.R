...
# Formulae
f <- bf(advanced_structures ~ poly(time, 2) * modality + 
          (poly(time, 1)|s|child:school) + (poly(time, 1)|p|school), 
        family = negbinomial()) +
     bf(events ~ poly(time, 2) * modality + 
          (poly(time, 1)|s|child:school) + (poly(time, 1)|p|school), 
        family = negbinomial()) +
     bf(syntax ~ poly(time, 2) * modality + 
          (poly(time, 1)|s|child:school) + (poly(time, 1)|p|school), 
        family = negbinomial()) +
     bf(number_words ~ poly(time, 2) * modality + 
          (poly(time, 1)|s|child:school) + (poly(time, 1)|p|school), 
        family = negbinomial()) + 
     bf(story_grammar ~ poly(time, 2) * modality + 
          (poly(time, 1)|s|child:school) + (poly(time, 1)|p|school), 
        family = sratio()) +
     bf(vocab_mean_age ~ poly(time, 2) * modality + 
          (poly(time, 1)|s|child:school) + (poly(time, 1)|p|school), 
        family = gaussian()) +
     bf(spelling_correct | trials(number_words) ~ poly(time, 2) * modality + 
          (poly(time, 1)|s|child:school) + (poly(time, 1)|p|school), 
        family = binomial(link = "logit")) + 
     bf(correct_spaces | trials(spacing_total) ~ poly(time, 2) * modality + 
          (poly(time, 1)|s|child:school) + (poly(time, 1)|p|school), 
        family = binomial(link = "logit")) + 
     bf(correct_terminators | trials(terminators_total) ~ poly(time, 2) * modality + 
          (poly(time, 1)|s|child:school) + (poly(time, 1)|p|school), 
        family = binomial(link = "logit")) 
...
# Save model
saveRDS(m, 
        file = "stanout/mv_time_x_modality_poly2.rda", 
        compress = "xz")
