...
# Formulae
f <- bf(advanced_structures ~ 1 + (time|s|child:school) + (time|p|school), 
        family = negbinomial()) +
     bf(events ~ 1 + (time|s|child:school) + (time|p|school), 
        family = negbinomial()) +
     bf(syntax ~ 1 + (time|s|child:school) + (time|p|school), 
        family = negbinomial()) +
     bf(number_words ~ 1 + (time|s|child:school) + (time|p|school), 
        family = negbinomial()) + 
     bf(story_grammar ~ 1 + (time|s|child:school) + (time|p|school), 
        family = sratio()) +
     bf(vocab_mean_age ~ 1 + (time|s|child:school) + (time|p|school), 
        family = gaussian()) +
     bf(spelling_correct | trials(number_words) ~ 1 + (time|s|child:school) + (time|p|school), 
        family = binomial(link = "logit")) + 
     bf(correct_spaces | trials(spacing_total) ~ 1 + (time|s|child:school) + (time|p|school), 
        family = binomial(link = "logit")) + 
     bf(correct_terminators | trials(terminators_total) ~ 1 + (time|s|child:school) + (time|p|school), 
        family = binomial(link = "logit")) 
