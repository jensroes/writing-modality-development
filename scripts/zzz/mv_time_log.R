...
# Formulae
f <- bf(advanced_structures ~ log(time) + (time|s|child:school) + (time|p|school), 
        family = negbinomial()) +
     bf(events ~ log(time) + (time|s|child:school) + (time|p|school), 
        family = negbinomial()) +
     bf(syntax ~ log(time) + (time|s|child:school) + (time|p|school), 
        family = negbinomial()) +
     bf(number_words ~ log(time) + (time|s|child:school) + (time|p|school), 
        family = negbinomial()) + 
     bf(story_grammar ~ log(time) + (time|s|child:school) + (time|p|school), 
        family = sratio()) +
     bf(vocab_mean_age ~ log(time) + (time|s|child:school) + (time|p|school), 
        family = gaussian()) +
     bf(spelling_correct | trials(number_words) ~ log(time) + (time|s|child:school) + (time|p|school), 
        family = binomial(link = "logit")) + 
     bf(correct_spaces | trials(spacing_total) ~ log(time) + (time|s|child:school) + (time|p|school), 
        family = binomial(link = "logit")) + 
     bf(correct_terminators | trials(terminators_total) ~ log(time) + (time|s|child:school) + (time|p|school), 
        family = binomial(link = "logit")) 
