...
# Formulae
f <- bf(advanced_structures ~ modality + time + (time|s|child:school) + (time|p|school), 
        family = negbinomial()) +
  bf(events ~ modality + time + (time|s|child:school) + (time|p|school), 
     family = negbinomial()) +
  bf(syntax ~ modality + time + (time|s|child:school) + (time|p|school), 
     family = negbinomial()) +
  bf(number_words ~ modality + time + (time|s|child:school) + (time|p|school), 
     family = negbinomial()) + 
  bf(story_grammar ~ modality + time + (time|s|child:school) + (time|p|school), 
     family = sratio()) +
  bf(vocab_mean_age ~ modality + time + (time|s|child:school) + (time|p|school), 
     family = gaussian()) +
  bf(spelling_correct | trials(number_words) ~ modality + time + (time|s|child:school) + (time|p|school), 
     family = binomial(link = "logit")) + 
  bf(correct_spaces | trials(spacing_total) ~ modality + time + (time|s|child:school) + (time|p|school), 
     family = binomial(link = "logit")) + 
  bf(correct_terminators | trials(terminators_total) ~ modality + time + (time|s|child:school) + (time|p|school), 
     family = binomial(link = "logit")) 
...
# Save model
saveRDS(m, 
        file = "stanout/mv_time_modality.rda", 
        compress = "xz")
